...
const items = [
  ...
  { q: "Do you handle permits?",
    a: "Yes, where permits are required, we handle the application and inspection coordination as part of the planning step. We work with the relevant county building departments across Pelion: Lexington, Richland, Aiken, and Saluda." },
  ...
  { q: "Do you cover my county?",
    a: "We serve the Pelion, SC: primarily Lexington, Richland, Aiken, and Saluda counties. If you're nearby and not sure, call us at (832) 954-7349 or send us your address through the estimate form. We'll let you know within one business day." },
